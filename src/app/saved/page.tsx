  ...
  if (loading) {
    return (
      <div className="flex flex-1 items-center justify-center p-8">
        <p className="text-slate-600 text-lg">{t('saved.loading')}</p>
      </div>
    );
  }
  ...
  if (routes.length === 0) {
    return (
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12">
        <p className="text-slate-600 text-center mb-4 text-lg">{t('saved.empty')}</p>
        <p className="text-base text-slate-500 text-center">{t('saved.empty_hint')}</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-1 flex-col overflow-auto px-5 py-6">
      <div className="flex-1">
        <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-3">{t('saved.title')}</h1>
        <p className="text-slate-600 mb-6 text-base">{t('saved.subtitle')}</p>
            ...
            <li key={route.id}>
              ...
              >
                <div className="flex justify-between items-start gap-3">
                  ...
                  <Chip variant="success">{t('saved.offline_chip')}</Chip>
                </div>
